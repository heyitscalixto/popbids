...
<h3 class="orange2 bold font-14" style="margin:0 0 2px;"><label><?php __('Latest news');?></label></h3>
...
<p class="more"><a href="/news"><?php __('View All News >>');?></a></p>
<?php else:?>
	<p><?php __('No news articles.');?></p>
<?php endif;?>