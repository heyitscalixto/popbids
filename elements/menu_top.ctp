...
<li><a style="font-family:robotoslab;cursor:auto;" href="javascript:void(0)"><?php __('Welcome') ?>, <strong><?php echo $session->read('Auth.User.username'); ?></strong></a></li>
...
.login_menu .slide_mayaccount a:hover{color:#fff;}
