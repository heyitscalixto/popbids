...
<div class="bold align-center orange2 congres"><label><?php __('Congratulations');?> </label></div>
<div class="bold align-center orange2 name"><label><?php echo $text->truncate($latest_winner['Winner']['username'], 15); ?>!</label></div>
    ...
    <div class="align-center">
    <label><?php __('End time');?> :  </label><span><?php echo $time->format('g:ia', $latest_winner['Auction']['end_time']); ?></span>
