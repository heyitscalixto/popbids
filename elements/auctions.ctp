...
<h4 style="margin: .25em 0 0; font-size: 140%; font-weight: normal; font-family:opensansbold; color:#ff9100;">Highest Bidder</h4>
...
<div class="username bid-bidder clearfix"><?php __('Highest bidder');?></div>
      ...
      <!--DEFINED in getstatus_functions.php-->
      <div style="margin: .25em 0 0; font-size: 120%; font-weight: normal; font-family:opensansbold; color:#ff9100" class="auction_price bid-price"><?php echo $number->currency($auction['Auction']['price'], $appConfigurations['currency']); ?>            
