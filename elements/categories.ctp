...
<?php foreach($categories as $category): ?>
	...
	margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h2><?php echo $html->link($category['Category']['name'], AppController::CategoryLink($category['Category']['id'], $category['Category']['name'])); ?></h2>
			</div>
			<div class="thumb">
...
<ul class="categories">
	...
	margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h2><a href="/auctions"><?php __('All items');?></a></h2>
	...
	<li style="border: 3px solid; 
		...
		<div class="align-center auction-item">
			<div class="title">
				<h2><a href="/auctions/future"><?php __('Future auctions');?></a></h2>
	...
	margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h2><a href="/auctions/winners"><?php __('Previous winners');?></a></h2>
	...
	margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h2><a href="/auctions/free"><?php __('Free auctions');?></a></h2>
